...
// Live state of a "remove blocked sections" run (issue #70), polled by the
// remove-blocked page. One run at a time — mirrors ClipExportProgress.
public sealed class BlockRemovalProgress
{
    ...
    private string _phase = "idle";   // idle | trimming | stopping | done | error
