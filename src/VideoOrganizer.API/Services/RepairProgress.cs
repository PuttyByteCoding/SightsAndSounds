...
// Live state of a video-repair run (issue #165), polled by the Playback Issues
// page. One run at a time — mirrors BlockRemovalProgress.
public sealed class RepairProgress
{
    ...
    private string _phase = "idle";   // idle | repairing | stopping | done | error
